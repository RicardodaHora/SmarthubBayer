import pandas as pd
df=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='comparativo')
dfd=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='Diseases_Table')
dfh=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='Hybrid_Description')
dfDN=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='DEREC_NREC')
dfFe=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='Fenotype')
dfMB=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='m_b_Cultivio_Brands')
dfStb=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='Stability_Cultivio_Brands')
dfh2h=pd.read_excel('arquivo_para_md (2).xlsx', sheet_name='H2H')
dfAg=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='Agronomicrisk')
dfcorp=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='Crop_Monitoring')
dftt=pd.read_excel('arquivo_para_md (26).xlsx', sheet_name='TT_cumulative')
...
df=df[df['tranfmgy']=='Subtropical_Summer']
...
w=pd.ExcelWriter('planilha_cultivio_changesnovo0808.xlsx')
