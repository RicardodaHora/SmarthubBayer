...
import time
daaltera=time.ctime()
tabela10 = pd.read_csv('/domino/datasets/local/MD/notedescrip1.csv')
descricao = pd.read_csv('/domino/datasets/local/MD/descricao1.csv')
tabela10a =tabela10
...
def page1br():
    ...
    return render_template("paginacornote.html",produt1=produt1,bio_tecnologia1=bio_tecnologia1,pipeline1=pipeline1,cb2=cb2,cb1=cb1,cb3=cb3,cb4=cb4,dados=dados,
...
def page3br():    
    ...
    return render_template("pagina_de_descricao.html",dados=dados, valor1=valor1)

def page4br():        
    descricao1t=pd.read_csv('/domino/datasets/local/salvar_arquivos/D_N_RECtmpbr.csv')
    descricao2t =pd.read_csv('/domino/datasets/local/MD/DEREC_NREC2.csv')
    ...
    return render_template("NDRECSAIDAbr.html",table=[table.to_html(classes='data', header="true")])
    
def page4abr():        
    descricao1t=pd.read_csv('/domino/datasets/local/MD/DEREC_NREC2.csv')
    table=descricao1t[:100]
    
    return render_template("NDRECSAIDAbr.html",table=[table.to_html(classes='data', header="true")])

def page5br():    
    descricao1t =pd.read_excel('/domino/datasets/local/salvar_arquivos/tempbr.xlsx')
    descricao2t =pd.read_excel('/domino/datasets/local/MD/rm_valores.xlsx')
    descricao2f=descricao1t.merge(descricao2t, how='left', suffixes=['', '_'], indicator=True)
    descricao2d=descricao2t.merge(descricao1t, how='left', suffixes=['', '_'], indicator=True)
    descricao2f=descricao2f[descricao2f['_merge']=='left_only']
    descricao2f['_merge']=descricao2f['_merge'].replace("left_only",":Novo")
    ...
    descricao2d['_merge']=descricao2d['_merge'].replace("left_only","Atual")
    table=pd.concat([descricao2f, descricao2d])    
    return render_template("rm_valoresbrs.html",table=[table.to_html(classes='data', header="true")])

def page6br():    
    descricao1t=pd.read_csv('/domino/datasets/local/salvar_arquivos/tempbr.csv')
    descricao2t =pd.read_csv('/domino/datasets/local/MD/dadosparafiltro.csv')
    descricao2f=descricao1t.merge(descricao2t, how='left', suffixes=['', '_'], indicator=True)
    descricao2d=descricao2t.merge(descricao1t, how='left', suffixes=['', '_'], indicator=True)
    descricao2f=descricao2f[descricao2f['_merge']=='left_only']
    descricao2f['_merge']=descricao2f['_merge'].replace("left_only",":Novo")
    ...
    return render_template("filtrobrs.html",table=[table.to_html(classes='data', header="true")])
...
def page7br():    
    ...
    return render_template("corpmonitorbrs.html",table=[table.to_html(classes='data', header="true")])

def page8br():    
    descricao1t=pd.read_csv('/domino/datasets/local/salvar_arquivos/tempbr.csv')
    descricao2t =pd.read_csv('/domino/datasets/local/MD/notedescrip1.csv')
    descricao2f=descricao1t.merge(descricao2t, how='left', suffixes=['', '_'], indicator=True)
    descricao2d=descricao2t.merge(descricao1t, how='left', suffixes=['', '_'], indicator=True)
    descricao2f=descricao2f[descricao2f['_merge']=='left_only']
    descricao2f['_merge']=descricao2f['_merge'].replace("left_only",":Novo")
    ...
    return render_template("cornnotebrs.html",table=[table.to_html(classes='data', header="true")])
...
def editar2br():
    if request.method == 'POST':
        ...
        hab2 = 0 
    dados1=descricao['descricao']      
    return render_template("paginacornote.html", produt1=produt1,bio_tecnologia1=bio_tecnologia1,pipeline1=pipeline1,cb2=cb2,cb1=cb1,cb3=cb3,cb4=cb4,dados=dados, hab2=hab2, dados1=dados1,desabilita1=desabilita1,
...
def salvar2br():
    ...
    hab2 = 0 
    notedescrip1.to_csv('/domino/datasets/local/MD/notedescrip1.csv',index = False)           
...
def gestaoprodutosbr():       
    ...
    return render_template("arquivogestao.html",cb2=cb2,cb1=cb1,cb3=cb3,cb4=cb4,cb5=cb5,nome=nome,produto1=" ",bio_tecnologia="",pipeline="",marca=" ",desabilita1=desabilita1,situacao=situacao,
...
def salvarbr1():
    ...
    nome=request.headers.get("domino-username")    
    descricao1t=pd.read_csv('/domino/datasets/local/salvar_arquivos/D_N_RECtmpbr.csv')
    descricao1t.to_excel('/domino/datasets/local/MD/exD_N_REC.xlsx', index = False)
    descricao2t =pd.read_csv('/domino/datasets/local/MD/DEREC_NREC2.csv')
    descricao2t.to_csv('/domino/datasets/local/backup_console/DEREC_NREC2'+ nome + datade +'.csv',index = False)
    descricao1t.to_csv('/domino/datasets/local/MD/DEREC_NREC2.csv',index = False)
    return render_template("salva1.html")
...
def salvarbr4():
    ...
    descricao1t =pd.read_excel('/domino/datasets/local/salvar_arquivos/tempbr.xlsx')    
    descricao2t =pd.read_excel('/domino/datasets/local/MD/rm_valores.xlsx') 
    descricao1t.to_excel('/domino/datasets/local/MD/rm_valores.xlsx', index = False)
    descricao1t.to_excel('/domino/datasets/local/MD/exrm_valores.xlsx', index = False)    
    descricao2t.to_excel('/domino/datasets/local/backup_console/rm_valores'+ nome + datade +'.xlsx',index = False)
...
def salvarbr5():
    ...
    datade=datade.replace(' ','_')
    nome=request.headers.get("domino-username")    
    descricao1dt=pd.read_csv('/domino/datasets/local/salvar_arquivos/tempbr.csv')
    descricao1dt.to_excel('/domino/datasets/local/MD/dadosparafiltro.xlsx', index = False)
    descricaod2t =pd.read_csv('/domino/datasets/local/MD/dadosparafiltro.csv')
    descricaod2t.to_csv('/domino/datasets/local/backup_console/dadosparafiltro'+ nome + datade +'.csv',index = False)
    descricao1dt.to_csv('/domino/datasets/local/MD/dadosparafiltro.csv',index = False)
    descricaot = descricao1dt
    descricao1n=pd.read_csv('/domino/datasets/local/MD/notedescrip1.csv')
    descricao1t =pd.read_csv('/domino/datasets/local/MD/doecasmcompleta.csv')
    ...
    descricao2final.to_csv('/domino/datasets/local/MD/doecasmcompleta.csv',index = False)
    descricao2nfinal.to_csv('/domino/datasets/local/MD/notedescrip1.csv',index = False)
    descricao2nfinal.to_excel('/domino/datasets/local/MD/exnotedescrip1.xlsx', index = False)
    return render_template("salvo3.html")
...
def salvarbr6():
    ...
    descricao1t =pd.read_excel('/domino/datasets/local/salvar_arquivos/tempbr.xlsx')    
    descricao2t =pd.read_excel('/domino/datasets/local/MD/corpmonitor.xlsx') 
    descricao1t.to_excel('/domino/datasets/local/MD/corpmonitor.xlsx', index = False)
    descricao1t.to_excel('/domino/datasets/local/MD/excorpmonitor.xlsx', index = False)    
    descricao2t.to_excel('/domino/datasets/local/backup_console/corpmonitor'+ nome + datade +'.xlsx',index = False)
    return render_template("salvo3.html")
...
def salvarbr7():
    ...
    nome=request.headers.get("domino-username")    
    descricao1t=pd.read_csv('/domino/datasets/local/salvar_arquivos/tempbr.csv')
    descricao1t.to_excel('/domino/datasets/local/MD/exnotedescrip1.xlsx', index = False)
    descricao2t=pd.read_csv('/domino/datasets/local/MD/notedescrip1.csv')
    descricao2t.to_csv('/domino/datasets/local/backup_console/notedescrip1'+ nome + datade +'.csv',index = False)
    descricao1t.to_csv('/domino/datasets/local/MD/notedescrip1.csv',index = False)
